              ...
              <div className="row">
                <div className="col-12 mt-1 mt-md-0">
                  <div className="footer-nav">
                    <h5><a href="https://5xruby.tw/">關於五倍紅寶石</a></h5>
                    <h5><a href="https://5xruby.tw/">媒體報導</a></h5>
                    <h5><a href="https://5xruby.tw/">團隊成員</a></h5>
                    <h5><a href="https://5xruby.tw/">聯絡詢價</a></h5>
                    <h5><a href="https://5xruby.tw/">常見問題</a></h5>
                    <h5><a href="https://5xruby.tw/">工作機會</a></h5>
                    <h5><a href="https://5xruby.tw/">開源專案</a></h5>
                    <h5><a href="https://5xruby.tw/">隱私條款</a></h5>
                    <h5><a href="https://5xruby.tw/">服務條款</a></h5>
                  </div>
                </div>
                <div className="col-12 mt-4">
                    <div className="row">
                      <div className="col-12 col-md-4 col-xl-3">
                        ...
                        <a href="https://5xruby.tw/"><i className="mr-3 ml-2 mt-3 media-icon fab fa-facebook-f"></i></a>
                        <a href="https://5xruby.tw/"><i className="mx-2 mt-3 media-icon fab fa-twitter"></i></a>
                        <a href="https://5xruby.tw/"><i className="mx-2 mt-3 media-icon fab fa-github"></i></a>
                      </div>
